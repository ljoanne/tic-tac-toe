...
export default function Square(props) {
    ...
    return ( 
      <button className={props.wins ? "square-win" : "square"} onClick={props.onClick}> {/* onClick is part of the built-in DOM that tells react to set up a click event listener*/}
        {props.value}
      </button>
    );
}